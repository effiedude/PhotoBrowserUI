...
import com.townspriter.android.photobrowser.ui.view.framework.BrowserTextView;
import com.townspriter.android.photobrowser.ui.view.framework.IBrowserTextView;
import com.townspriter.android.photobrowser.ui.view.framework.widget.BrowserIndicateView;
import com.townspriter.android.photobrowser.ui.view.framework.widget.MaxSizeFrameLayout;
...
public class PhotoInfoPage extends MaxSizeFrameLayout
{
    ...
    private void changeBackgroundAlpha(boolean alpha)
    {
        ...
        if(alpha)
        {
            setBackgroundColor(ResHelper.getColor(R.integer.valuexintegerxalphax75,R.color.valuexcolorxblack));
        }
        else
        {
            GradientDrawable gradientDrawable=new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM,new int[]{ResHelper.getColor(R.color.valuexcolorxtranslate),ResHelper.getColor(R.integer.valuexintegerxalphax60,R.color.valuexcolorxblack),});
