...
public class TopBar extends FrameLayout
{
    ...
    {
        super(context);
        GradientDrawable gradientDrawable=new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP,new int[]{ResHelper.getColor(R.color.valuexcolorxtranslate),ResHelper.getColor(R.integer.valuexintegerxalphax60,R.color.valuexcolorxblack),});
    ...
    private FrameLayout createTitleView(String title)
    {
        ...
        mTitle.setTextColor(ResHelper.getColor(R.color.valuexcolorxred));
